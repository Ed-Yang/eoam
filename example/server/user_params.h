...
#define EOAM_PKT_PATH           "/tmp/eoam.pkt.sock"
#define EOAM_CFG_PATH           "/tmp/eoam.cfg.sock"
...
#define OAM_PARAM_OUI           {0x11, 0x11, 0x11} /* apple */
#define OAM_PARAM_VENDOR        0x11223344 /* */

#define OAM_PARAM_LOG_TBL_SIZE  4
